...
class ReplayBuffer():
    def __init__(
        ...
        super().__init__()
        self.max_replay_buffer_size = int(max_replay_buffer_size / trajectory_length)
        ...
        self.sim_data.create_dataset('actions', (self.max_replay_buffer_size, self.trajectory_length, 5), dtype='f')
